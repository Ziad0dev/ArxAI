...
CONFIG = {
    ...
    'embedding_cache_size': 30000,  # Increased from 20000
    'embedding_batch_size': 16,  # Increased from 8
    'embedding_max_length': 1024,  # Increased from 768
    'embedding_max_workers': RECOMMENDED_WORKERS,
    
    # Transformer Models
    'embedding_model': 'allenai/specter2',
    'embedding_size': 1536,  # Increased from 768
    'use_sentence_transformer': True,
    'sentence_transformer_model': 'sentence-transformers/all-mpnet-base-v2',
    
    # Concept Extraction
    'max_features': 10000,  # Increased from 7500
    'top_n_concepts': 100,  # Increased from 75
    'domain_keywords': [
        'machine learning', 'neural network', 'deep learning', 'artificial intelligence', 
        'transformer', 'attention mechanism', 'code generation', 'reinforcement learning', 
        'representation learning', 'data science', 'large language model'
    ],

    # Model Training Parameters
    'model_name': 'EnhancedClassifier',
    'hidden_size': 1536,  # Increased from 1024
    'dropout_rate': 0.2,
    'max_seq_length': 1024,  # Increased from 768
    'batch_size': 16,  # Adjusted for larger model
    'epochs': 20,  # Increased from 15
    'learning_rate': 5e-5,  # Adjusted for stability with larger model
    'weight_decay': 1e-6,  # Adjusted for larger model
    'warmup_steps': 0.1,
    'early_stopping_patience': 5,  # Increased from 4
    ...
    'replay_buffer_size': 3000,  # Increased from 2000
    'incremental_learning_rate': 5e-5,
    'incremental_epochs': 8,  # Increased from 5
    
    # Research Parameters
    'papers_per_query': 75,  # Increased from 30
    'max_papers_per_query': 100,  # Increased from existing value
    'max_papers_total': 750,  # Adjusted based on increased papers_per_query
